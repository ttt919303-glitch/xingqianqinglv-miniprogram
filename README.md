...
**行前晴旅** 是一个旅行出行准备类微信小程序，副标题为“轻松规划每一次出发”。作品聚焦出发前最容易遗漏的几件事：行程时间、交通安排、当天景点、物品清单、旅行模板和路线推荐。
...
- `npm run test`：验证新增物品、新增行程、路线推荐、腾讯地图请求构造、数据重置等核心逻辑。
